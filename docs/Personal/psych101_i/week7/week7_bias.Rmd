...
subtitle: "<br><br>Psych 101"
author: "Amanda D. Perez, PhD"
output:
  xaringan::moon_reader:
    css: ["https://amandadperez.github.io/TutoRials/docs/Personal/psych101_i/xaringan-themer.css", "https://amandadperez.github.io/TutoRials/docs/Personal/psych101_i/slides.css"]
    lib_dir: libs
    nature:
      ratio: "16:9"
      highlightLines: true
...
knitr::include_graphics("img/hathaway-effect-poster.jpeg")
```
]
...
And it’s biased against Black people.
]
...
.pull-left[
<img src="img/propublica-prater-broden-1.png" width="450">
]
--
.pull-right[
<img src="img/propublica-prater-broden-2.png" width="450">
]
...
knitr::include_graphics("img/ethics-data-science.jpeg")
```
]
.pull-right[
...
.pull-left[
```{r echo=FALSE, out.width="65%"}
knitr::include_graphics("img/weapons-of-math-destruction.jpeg")
```
]
.pull-right[
...
.pull-left[
```{r echo=FALSE, out.width="65%"}
knitr::include_graphics("img/algorithms-of-oppression.jpeg")
```
]
.pull-right[
...
- At some point during your learning journey you will learn tools that can be used unethically
- You might also be tempted to use your knowledge in a way that is ethically questionable either because of business goals or for the pursuit of further knowledge (or because your boss/advisor told you to do so)
