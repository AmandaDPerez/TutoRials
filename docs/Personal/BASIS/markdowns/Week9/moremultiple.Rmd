---
title: "More Models w/ Multiple Predictors"
...
pp_main_fit <- lm(log_price ~ Surface + artistliving, data = pp_Surf_lt_5000)
tidy(pp_main_fit)
```
]
...
pp_int_fit <- lm(log_price ~ Surface * artistliving, data = pp_Surf_lt_5000)
tidy(pp_int_fit)
```
]
